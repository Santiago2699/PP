...
(*if 3 = 4 then 0 else "4";;*)
(*Error de tipos: los tipos del then y else deben ser iguales*)
...
(*z;;*)
(*Error: z no tiene ningun valor ligado *)
...
(*l 2;;*)
(*Error de tipos: la funcion pide float y se le pasa un int*)

(*pi;;*)
(*Error: pi no tiene ningun valor ligado*)
